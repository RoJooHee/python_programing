...
wise_saying_notebook.add_note(note_1, 100) #페이지 100에 뭐 넣은적 없는데 왜 해당페이지에 이미 노트 존재한다고 뜨지?
wise_saying_notebook.add_note(note_1, 100)

for i in range(300):
    wise_saying_notebook.add_note(note_1, i) #note 1,2,4는 차있어서 3번 해당페이지에 이미 노트 존재한다고 뜸
